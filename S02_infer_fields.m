...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [fltr,sshHighPass]=ellipseFltr(semi,ssh)
    ...
    blurred=filter2(fltr,padarray(ssh,[semiy semix],'symmetric'));
    sshHighPass=(ssh - blurred(semiy+1:end-semiy,semix+1:end-semix));
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
