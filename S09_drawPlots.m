...
function S09_drawPlots
    ...
    ticks.vel=[-30;20;6];
    %     TODO repair map.out
    ticks.axis=[DD.map.in.west  DD.map.in.east DD.map.in.south DD.map.in.north];
...
%     %     end
    ...
    %     mapstuff(procData.maps,procData.vecs,DD,ticks,procData.lo,procData.la)
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
