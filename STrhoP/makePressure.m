function makePressure
    ...
    for ii=1:numel(rhoFiles)
        T=    disp_progress('kuguz',T,numel(rhoFiles));
        opDay(sshFiles,rhoFiles,ii,G,dDEP,Y,X,Z,outDir)
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function opDay(sshFiles,rhoFiles,ii,G,dDEP,Y,X,Z,outDir)
    ...
    [~,b,c]=fileparts(Frho);
    Pname = [outDir 'pressure_' b(5:end) c];
